...
const groups = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'closedDates', label: 'Days we are closed', type: 'list', itemLabel: 'date', default: [], maxItems: 30, help: 'One-off closures — one per line, e.g. "2026-09-15" or "Monday, September 15, 2026". Blocks table reservations AND pasta-shop pickups for that day. Past dates block nothing, so old lines are harmless; delete them when you tidy up. For a day you are closed EVERY week, set that weekday to "closed" above instead.' }
    ]
  },
  {
    id: 'classes',
