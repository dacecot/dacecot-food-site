...
const groups = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'classWeeksShown', label: 'How many Sundays to show', type: 'number', default: 5, min: 1, max: 12, required: true, help: 'How far ahead guests can book. 4–5 keeps the form short and the classes full.' },
